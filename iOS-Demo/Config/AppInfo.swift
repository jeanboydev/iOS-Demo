...
struct AppInfo {
    ...
    //应用程序信息
    static let appDisplayName = Bundle.main.infoDictionary!["CFBundleDisplayName"]! //程序名称
    static let versionName = Bundle.main.infoDictionary!["CFBundleShortVersionString"]! //主程序版本号
    static let versionCode = Bundle.main.infoDictionary!["CFBundleVersion"]! //版本号（内部标示）
